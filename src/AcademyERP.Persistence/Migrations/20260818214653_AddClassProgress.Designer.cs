...
namespace AcademyERP.Persistence.Migrations
{
    ...
    [Migration("20260818214653_AddClassProgress")]
    partial class AddClassProgress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcademyERP.Domain.Entities.AcademicProgress.ClassProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<bool>("HomeworkCompleted")
                        .HasColumnType("bit");

                    b.Property<bool>("HomeworkGiven")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("PagesCovered")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AcademyERP.Domain.Entities.Admissions.AdmissionApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AcademyERP.Domain.Entities.Finance.FeePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AcademyERP.Domain.Entities.Finance.PaymentMethod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AcademyERP.Domain.Entities.AcademicProgress.ClassProgress", b =>
                {
                    b.HasOne("AcademyERP.Domain.Entities.ScheduledClasses.ScheduledClass", "ScheduledClass")
                        .WithMany()
            ...
            modelBuilder.Entity("AcademyERP.Domain.Entities.Finance.FeePayment", b =>
                {
                    b.HasOne("AcademyERP.Domain.Entities.Finance.FeeInvoice", "FeeInvoice")
                        .WithMany("Payments")
                        .HasForeignKey("FeeInvoiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AcademyERP.Domain.Entities.Finance.PaymentMethod", "PaymentMethod")
                        .WithMany("Payments")
